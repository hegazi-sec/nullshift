...
class GenericOpenAICompatibleProvider(LLMProvider):
    ...
    Covers DeepSeek, Gemini, Groq, Mistral, xAI, Cohere, Together AI,
    Perplexity, OpenRouter, and Ollama — all speak the same API shape.
...
def reload_providers() -> Dict[str, bool]:
    ...
    for name in ("gemini", "groq", "mistral", "xai", "cohere", "together", "perplexity", "openrouter", "qwen", "kimi"):
...
_VISION_CAPS: Dict[str, Dict[str, Any]] = {
    ...
    "together":          {"supported": True,  "note": "Together AI — vision via Llama 4, Qwen3.5 models"},
    "openrouter":        {"supported": True,  "note": "OpenRouter — vision depends on the routed model"},
    "mistral":           {"supported": True,  "note": "Mistral — vision via pixtral-large-2411 and pixtral-12b-2409"},
    ...
    "cohere":            {"supported": False, "note": "Cohere Command — vision not supported"},
