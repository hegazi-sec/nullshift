...
- 🧠 **15+ LLM providers** — Claude Agent SDK (use your Claude subscription, no API key), cloud APIs, or fully local Ollama (even hosted on another machine over Tailscale).
...
- **Google Gemini, Groq, Mistral, xAI, Cohere, DeepSeek, Together, Perplexity, OpenRouter, Qwen, Kimi**
